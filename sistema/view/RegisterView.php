		...
		if($this->msg != "")
		{
			...
			switch($this->msg)
			{
				...
				case "mismatchPassword":
					$this->specifiedMsg = "Password nуo confere, tente novamente";
					break;
				//Jс existe email cadastrado
				case "registeredEmail":
					$this->specifiedMsg = "Esse email jс consta nos registros, por favor coloque outro";
					break;
				//Jс existe alias cadastrado
				case "registeredAlias":
					$this->specifiedMsg = "Esse Alias jс consta nos registros, por favor coloque outro";
					break;
			}
		}
